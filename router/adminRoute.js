...
let numberGeneratorFunction = () => {
    return otpGenerator.generate(10, { upperCaseAlphabets: false, specialChars: false, lowerCaseAlphabets: true });
}
...
adminRoutes.post("/properties", async (req, res) => {
    try {
        ...
        let propertyId = numberGeneratorFunction();
        newPropertiesData["propertyId"] = propertyId;
        
        const createdProperties = new PropertiesModel(newPropertiesData);
        await createdProperties.save();
